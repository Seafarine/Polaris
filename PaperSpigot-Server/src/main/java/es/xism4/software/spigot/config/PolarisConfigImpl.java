...
public class PolarisConfigImpl extends SafeYamlSerializable {
    ...
    public static final PolarisConfigImpl IMP = new PolarisConfigImpl();

    public PolarisConfigImpl() {
        super(Paths.get("Polaris","config.yml"), SPIGOT_CONFIG);
    }

    @Comment(value = {
            @CommentValue("Polaris - Custom fork for Seafarine"),
            @CommentValue(""),
            @CommentValue("Version: 0.0.1"),
            @CommentValue("Author: xism4"),
            @CommentValue(""),
            @CommentValue("Web: https://www.seafarine.com/"),
    })
   ...
   @Comment(value = {
    ...
    public String NETTY_HANDLER_PREFIX = "Polaris?";
