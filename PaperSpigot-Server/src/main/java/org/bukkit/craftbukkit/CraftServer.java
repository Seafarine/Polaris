...
public final class CraftServer implements Server {
    ...
    private final String serverName = "ShieldSpigot";
    ...
    public void loadPlugins() {
        ...
        if (pluginFolder.exists()) {
            ...
            if (!Boolean.getBoolean("ComuGamers.MeGuenSpark")) {
                try {
                    ...
                    getLogger().severe("ComuGamers: Failed to download and install spark plugin");
                    e.printStackTrace();
                }
            }
    ...
    public boolean dispatchCommand(CommandSender sender, String commandLine) {
        ...
        if (!Bukkit.isPrimaryThread()) {
            ...
            Bukkit.getLogger().log(Level.SEVERE, "Please notify author of plugin causing this execution to fix this bug! see: https://bit.ly/1oSiM6C", new Throwable());
        ...
        if (internal.getWorld().getKeepSpawnInMemory()) {
            ...
            for (int j = -short1; j <= short1; j += 16) {
                for (int k = -short1; k <= short1; k += 16) {
                    ...
                    internal.chunkProviderServer.getChunkAt(chunkcoordinates.getX() + j >> 4, chunkcoordinates.getZ() + k >> 4, () -> {}); //ShieldSpigot async
                }
            }
        }
    ...
    public boolean unloadWorld(World world, boolean save) {
        ...
        if (save) {
            ...
            IChunkLoader regionLoader = chunkProviderServer.chunkLoader;

            // Only do this if we're using the default region loader,
            // otherwise we will break plugins such as SlimeWorldManager.
            if(regionLoader instanceof ChunkRegionLoader) {
                ChunkRegionLoader defaultRegionLoader = (ChunkRegionLoader) regionLoader;
                defaultRegionLoader.b.clear();
                defaultRegionLoader.c.clear();
            }
