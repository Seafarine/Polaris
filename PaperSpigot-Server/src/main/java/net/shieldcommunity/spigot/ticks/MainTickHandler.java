package net.shieldcommunity.spigot.ticks;
...
public abstract class MainTickHandler<R extends Runnable> implements Executor {
    ...
    protected MainTickHandler(String name) {
        this.name = name;
    }
