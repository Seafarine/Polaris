package net.shieldcommunity.spigot.cache;
...
public final class CachedMapList<T> extends AbstractReferenceList<T> implements Set<T> {
    ...
    public CachedMapList() {
        this(2, 0.8f);
    }

    public CachedMapList(int expectedSize, float loadFactor) {
    ...
    private class Iterator implements ObjectListIterator<T> {
        ...
        public boolean hasNext() {
            return this.current < CachedMapList.this.count;
        }
        ...
        @Override
        public T next() {
            if (this.current >= CachedMapList.this.count) {
                throw new NoSuchElementException();
            }
            return this.lastRet = CachedMapList.this.elements[this.current++];
        }
        ...
        public void remove() {
            ...
            CachedMapList.this.remove(lastRet);
            --this.current;
        }
