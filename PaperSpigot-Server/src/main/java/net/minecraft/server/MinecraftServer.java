...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
    ...
    protected final Queue<FutureTask<?>> j = new CachedConcurrentLinkedQueue<>();
    ...
    private void a(ServerPing serverping) {
        ...
        if (file.isFile()) {
            ...
            try {
                ...
                serverping.setFavicon("data:image/png;base64," + cachedByteBuf.toString(Charsets.UTF_8));
            } catch (Exception exception) {
                MinecraftServer.LOGGER.error("Couldn\'t load server icon", exception);
            } finally {
                bytebuf.release();
                if (cachedByteBuf != null)
                    cachedByteBuf.release();
            }
        }
    ...
    public String getServerModName() {
        return "ComuGamers"; // ComunGamers - > PaperSpigot - PaperSpigot > // Spigot - Spigot > // CraftBukkit - cb > vanilla!
    }
