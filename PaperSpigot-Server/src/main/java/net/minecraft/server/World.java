...
public abstract class World implements IBlockAccess {
    ...
    public void b(int i, int j, int k, int l, int i1, int j1) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(i, j, k, l, i1, j1);
        }
    ...
    public void makeSound(Entity entity, String s, float f, float f1) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(s, entity.locX, entity.locY, entity.locZ, f, f1);
        }
    ...
    public void a(EntityHuman entityhuman, String s, float f, float f1) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(entityhuman, s, entityhuman.locX, entityhuman.locY, entityhuman.locZ, f, f1);
        }
    ...
    public void makeSound(double d0, double d1, double d2, String s, float f, float f1) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(s, d0, d1, d2, f, f1);
        }
    ...
    public void a(BlockPosition blockposition, String s) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(s, blockposition);
        }
    ...
    private void a(int i, boolean flag, double d0, double d1, double d2, double d3, double d4, double d5, int... aint) {
        for (IWorldAccess iWorldAccess : this.u) {
            ((IWorldAccess) iWorldAccess).a(i, flag, d0, d1, d2, d3, d4, d5, aint);
        }
                ...
                for (int l1 = k; l1 < l; ++l1) {
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        if (block.getMaterial() == material) {
                            double d0 = (float) (l1 + 1) - BlockFluids.b((Integer) iblockdata.get(BlockFluids.LEVEL));
    ...
    public EntityHuman findNearbyPlayer(double d0, double d1, double d2, double d3) {
        ...
        for (int i = 0; i < this.players.size(); ++i) {
            ...
            // CraftBukkit start - Fixed an NPE
            if (entityhuman1 == null || !entityhuman1.ad())  {
                continue;
            }
            // CraftBukkit end
    ...
    public EntityHuman findNearbyPlayerWhoAffectsSpawning(double d0, double d1, double d2, double d3) {
        ...
        for (int i = 0; i < this.players.size(); ++i) {
            EntityHuman entityhuman1 = (EntityHuman) this.players.get(i);
            // CraftBukkit start - Fixed an NPE
            if (entityhuman1 == null || !entityhuman1.ad() || !entityhuman1.affectsSpawning) {
                continue;
            }
            // CraftBukkit end
