...
import net.shieldcommunity.api.PlayerHandshakeHandler;
    ...
    public void a(PacketHandshakingInSetProtocol packethandshakinginsetprotocol) {
        switch (HandshakeListener.SyntheticClass_1.a[packethandshakinginsetprotocol.a().ordinal()]) {
            case 1:
                ...
                try {
                    if (!(this.b.channel.localAddress() instanceof io.netty.channel.unix.DomainSocketAddress)) { //
                ...
                if (packethandshakinginsetprotocol.b() > 47) {
                    ...
                    if (PlayerHandshakeHandler.getHandlerList().getRegisteredListeners().length != 0) { // Hello? Can you hear me?
                        ...
                        PlayerHandshakeHandler event = new PlayerHandshakeHandler(packethandshakinginsetprotocol.hostname, hostnameOfRemote, !proxyLogicEnabled);
                        ...
                        if (!event.isCancelled()) {
                            ...
                            if (event.getSocketAddressHostname() != null)
                                this.b.l = new java.net.InetSocketAddress(event.getSocketAddressHostname(), socketAddress instanceof java.net.InetSocketAddress ? ((java.net.InetSocketAddress) socketAddress).getPort() : 0);
