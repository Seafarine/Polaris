...
public class EntityPlayer extends EntityHuman implements ICrafting {
    ...
    public final java.util.Deque<Integer> removeQueue = new java.util.ArrayDeque<>();
    ...
    public void die(DamageSource damagesource) {
        ...
        IChatBaseComponent chatmessage = damagesource == DamageSource.GENERIC ? damagesource.getLocalizedDeathMessage(this) : this.bs().b();
    ...
    public void copyTo(EntityHuman entityhuman, boolean flag) {
        ...
        this.bN = -1;
        if (this.removeQueue !=
                ((EntityPlayer) entityhuman).removeQueue) {
            this.removeQueue.addAll((
                    (EntityPlayer) entityhuman).removeQueue
            );
        }
    }
