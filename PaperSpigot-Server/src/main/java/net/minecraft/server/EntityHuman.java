...
public abstract class EntityHuman extends EntityLiving {
    ...
    protected void h() {
        super.h();
        this.datawatcher.a(16, (byte) 0); //cache?
        ...
        if (this.vehicle != null) {
            ...
            if (i > 0) {
                if (this.vehicle instanceof EntityMinecartAbstract) {
                    ...
                    } else if (this.e.c(MathHelper.floor(this.locX), (double) MathHelper.floor(this.locY), (double) MathHelper.floor(this.locZ)) >= 1000000.0D) {
