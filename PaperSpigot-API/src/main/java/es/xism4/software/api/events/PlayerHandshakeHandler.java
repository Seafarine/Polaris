package es.xism4.software.api.events;
 ...
 */
public class PlayerHandshakeHandler extends Event implements Cancellable {
    ...
    /**
     * Creates a new {@link PlayerHandshakeHandler}.
     *
     * @param originalHandshake the original handshake string
     * @param cancelled         if this event is enabled
     * @deprecated in favour of {@link PlayerHandshakeHandler (String, String, boolean)}
     */
    @Deprecated
    public PlayerHandshakeHandler(String originalHandshake, boolean cancelled) {
     ...
     * @param cancelled                     if this event is enabled
     */
    public PlayerHandshakeHandler(String originalHandshake, String originalSocketAddressHostname, boolean cancelled) {
        super(true);
